    ...
    return (
        <div>
            <Container className="panel" style={styles.container}>
                <Form>
                    <h1>회원가입</h1>
                    <Form.Group as={Row} className="mt-5" controlId="formBasicEmail">
                        <Col sm>
                    ...
                    <Form.Group as={Row} className="mt-3" controlId="text">
                        <Col sm>
                            <Form.Control type="text" placeholder="UserName" />
                        </Col>
                    </Form.Group>

                    <Form.Group as={Row} className="mt-3" controlId="number">
                        <Col sm>
                            <Form.Control type="tel" placeholder="Pnone-Number" />
                        </Col>
                    </Form.Group>
                    ...
                    <Form>
                        ...
                        <select data-testid="login-signup-countrycode" className="countrycode" id="country">
                            ...
                            <option value="82KR">한국 (+82)</option>
