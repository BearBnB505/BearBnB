...
function LodgingLocationDetail(){
    ...
    console.log('잘 넘어왔는지 테스트')
    console.log(map.address1);
    ...
    return(
        <div>
                        ...
                        <div className={'col-7 mx-auto p-5'} style={{marginTop : "100px"}}>
                            ...
                            <div className={'col-12'}>
                                <div className={'mt-5'}>
                                    ...
                                    <input type="text" className="form-control" id="address1" name="address1" defaultValue={map.address1}
                                           placeholder="주소" />
                                </div>
                                <div className={'mt-3'}>
            ...
            <Link to = {"/reg/lodgingBasicInfo"}><button className={"btn btn-primary position-absolute end-0 bottom-0"} style={{marginBottom:"70px", marginRight:"120px", width:"200px", fontSize:"25px", padding:"8px", }} onClick={() => {
                dispatch(locationDetails({addr2:address2A, zipCode:zipCodeA}))
            }}>다음</button></Link>
            </div>
        </div>
    )
