    ...
    return (
        <motion.div variants={Anima}
            ...
            <div className={"row"}>
                ...
                <Link className={"col-sm-4"} to={`/hostMyPageHostInfo`} state={{userId: userId}}>
                ...
                <Link className={"col-sm-4"} to={`/hostMyPageLodging`} state={{userId: userId}}>
                ...
                <Link className={"col-sm-4"} to={`/hostMyPageBooking`} state={{userId: userId}}>
                ...
                <Link className={"col-sm-4"} to={`/hostMyPageReview`} state={{userId: userId}}>
