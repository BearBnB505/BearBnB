  ...
  return (
    <div>
      <div className={'IntroContents'}>
        ...
        <div className={'IntroTextLine2'}>한국어</div>
        <div className={'IntroTextLine1'}>숙박 중 게스트와의 교류</div>
        <Button style={{gridColumn: 2 / 4}} className={'IntroBtn'} variant="dark">호스트에게 연락하기</Button>
        <div>

        </div>
        <div className={'IntroText2'}>ONDA는 다양한 숙박업소분들과 함께 일하는 팀입니다.
          한국의 각 지역의 멋진 숙박업소를 찾아 고객님께 연결해주는
          일을 하고 있습니다.
          업무시간은 한국시간으로 10:00~18:00입니다.
          예약이 완료 되시면 ONDA로 예약확정 문자를 드립니다.
        ...
        <img className={'IntroNoticeImg'} src={"/EctIcon/noticeBear4.png"}/>
