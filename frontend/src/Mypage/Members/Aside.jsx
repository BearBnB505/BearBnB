...
function Aside() {
    return (
        <>
            <div className={"col-sm-4 d-sm-block"}>
                <div className={"card rounded p-1"}>
                    <div className={"card-body text-start"}>
                        <div className={"p-2"}>
                            <p>
                                <FontAwesomeIcon icon={faUserShield} size="3x"/><br/><br/>
                            ...
                            <p>
                                <FontAwesomeIcon icon={faUserLock} size="3x"/><br/><br/>
                            ...
                            <p>
                                ...
                                <FontAwesomeIcon icon={faEye} size="3x"/><br/><br/>
